    ...
    topics: [
      ...
      },
      {
        ...
        content: {
          ...
          howItWorks: 'Implement middleware that tracks rate limit state and adds HTTP headers to responses: X-RateLimit-Limit, X-RateLimit-Remaining, X-RateLimit-Reset, Retry-After (on 429). Must be consistent across all endpoints.',
          useCases: [
            'Any public API',
            'API dashboards',
            'Client SDKs',
          ...
          cons: [
            ...
            'Security through obscurity risk',
          ],
        },
      },
    ],
